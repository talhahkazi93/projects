...
def encryptMsg(msg):
  ...
  iv_bytes = initVector.encode('utf-8')
  aes_key = key.encode('utf-8')
  cypher = AES.new(aes_key, AES.MODE_CBC, iv_bytes)
  encryptedMsg = cypher.encrypt(base64.b64encode(msg))
  return encryptedMsg
...
def decryptMsg(msg):
  ...
  aes_key = key.encode('utf-8')
  cypher = AES.new(aes_key, AES.MODE_CBC, iv_bytes)
  decryptedMsg = cypher.decrypt(base64.b64decode(msg))
  return decryptedMsg

def changeMessage(msg):
  decryptedMsg = decryptMsg(msg)
  print decryptedMsg
  encryptedMsg = encryptMsg(decryptedMsg)
  print encryptedMsg
  return 
