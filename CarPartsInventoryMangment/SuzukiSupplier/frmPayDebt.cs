...
namespace SuzukiSupplier
{
    ...
    {
        public static frmPayDebt PublicPayDebtForm = null;
        public frmPayDebt()
        {
            InitializeComponent();
        }
        ...
        private void btnAddPayment_Click(object sender, EventArgs e)
        {
            ...
            frmDebtAddPayment frmDebtAddPayment = new frmDebtAddPayment();
            frmDebtAddPayment.DebtId = int.Parse(debtID);
            frmDebtAddPayment.ShowDialog();
        }
